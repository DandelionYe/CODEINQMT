# -*- coding: utf-8 -*-
"""
validate_alpha_v6_robustness.py

Alpha v6 稳健性验证模块：判断 full-run walk-forward 结果是否足够稳健，
...
运行示例：
python scripts/validate_alpha_v6_robustness.py --input-tag <tag> --run-id exp006_alpha_v6_full --no-png
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Alpha v6 稳健性验证")
    ...
    output_dir = output_root / f"alpha_v6_robustness_{args.run_id}"
    ...
    csv_tables = {
        "alpha_v6_robustness_summary": summary_df,
        "alpha_v6_robustness_leave_one_year_out": loyo_df,
        "alpha_v6_robustness_exclude_years": exclude_df,
        "alpha_v6_robustness_yearly_contribution": yearly_df,
        "alpha_v6_robustness_benchmark": benchmark_df,
        "alpha_v6_robustness_variant": variant_df,
        "alpha_v6_robustness_parameters": param_df,
        "alpha_v6_robustness_concentration": concentration_df,
        "alpha_v6_robustness_train_test": train_test_df,
        "alpha_v6_robustness_decision": pd.DataFrame(gates),
    }
