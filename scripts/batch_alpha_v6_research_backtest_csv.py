# -*- coding: utf-8 -*-
"""
batch_alpha_v6_research_backtest_csv.py
...
1. 小规模测试：
python scripts\\batch_alpha_v6_research_backtest_csv.py --market SZ --security-type stock --limit 50 --alpha-variant-list short_term_reversal,low_volatility --reversal-window-list 10 --vol-window-list 60 --benchmark-list 000300.SH --benchmark-ma-list 120 --start 20150101 --workers 4

2. 全市场参数网格：
python scripts\\batch_alpha_v6_research_backtest_csv.py --market ALL --security-type stock --alpha-variant-list short_term_reversal,low_volatility,turnover_reversal,volume_price_divergence --reversal-window-list 5,10,20 --vol-window-list 20,60,120 --turnover-short-list 10 --turnover-long-list 60 --divergence-window-list 10,20,60 --benchmark-list 000300.SH,000905.SH,000852.SH --benchmark-ma-list 120,250 --start 20150101 --sample-mode short --workers 10
"""
...
BACKTEST_DIR = PROJECT_ROOT / "backtests" / "batch_alpha_v6_research_csv"
BACKTEST_DIR.mkdir(parents=True, exist_ok=True)

CFG = WFConfig(
    alpha_version="alpha_v6",
    output_dir_name="batch_alpha_v6_research_csv",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Alpha v6 Research 批量回测")
...
def main() -> None:
    ...
    summary_path = BACKTEST_DIR / f"batch_alpha_v6_summary_{tag}.csv"
    top50_path = BACKTEST_DIR / f"batch_alpha_v6_top50_{tag}.csv"
    skipped_path = BACKTEST_DIR / f"batch_alpha_v6_skipped_{tag}.csv"
    errors_path = BACKTEST_DIR / f"batch_alpha_v6_errors_{tag}.csv"
